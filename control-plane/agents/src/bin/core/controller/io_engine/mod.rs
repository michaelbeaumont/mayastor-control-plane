...
use stor_port::{
    ...
    types::v0::transport::{
        ...
        Replica, ReplicaId, ReplicaSnapshot, ResizeReplica, SetReplicaOwner, ShareNexus,
        ShareReplica, ShutdownNexus, UnshareNexus, UnshareReplica,
    },
};
